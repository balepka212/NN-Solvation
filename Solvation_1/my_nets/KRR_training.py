...
def KRR_experiment(solvent, solute, number=1, n_jobs=None):
    ...
    for kernel in kernels:
        ...
        with open(project_path(f'Solvation_1/Run_results/{runs_folder}/timing.pkl'), 'wb') as f:
            pkl.dump(timing_dict, f)

    for folder in ('Runs', 'Run_results'):
        with open(project_path(f'Solvation_1/{folder}/{runs_folder}/best_models.pkl'), 'wb') as f:
    ...
    with open(project_path(f'Solvation_1/Run_results/{runs_folder}/all_curves.pkl'), 'wb') as f:
