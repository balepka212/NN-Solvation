...
directory = os.fsencode(project_path('Solvation_1/Tables/Reserve/all_solutes'))

for i, file in enumerate(os.listdir(directory)):
    filename = os.fsdecode(file)
    if filename.endswith(".xyz"):
        # print(f'{i}: {filename}')
        file_path = project_path('Solvation_1/Tables/Reserve/all_solutes/'+filename)
        xyz_from_file(file_path, project_path('Solvation_1/Tables/Reserve/xyz_files'), copy=False)
