...
from Vectorizers.vectorizers import get_sdf_file, get_dictionary
import torch
...
# with open('/Users/balepka/PycharmProjects/msuAI/Tables/MNSol_bags2.pkl', 'rb') as f:
#     my_bags = pkl.load(f)
#
# # my_bags.append((BAT_bags, BAT_sizes))
# #
# # with open('/Users/balepka/PycharmProjects/msuAI/Tables/MNSol_bags2.pkl', 'wb') as f:
# #     pkl.dump(my_bags, f)
#
...
with open('/Users/balepka/PycharmProjects/msuAI/Tables/MNSol_bags3.pkl', 'wb') as f:
    pkl.dump(my_bags, f)
